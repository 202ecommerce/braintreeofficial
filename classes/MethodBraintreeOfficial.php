...
class MethodBraintreeOfficial extends AbstractMethodBraintreeOfficial
{
    ...
    protected function initConfig($order_mode = null)
    {
        ...
        $this->gateway = new Braintree_Gateway(['environment' => $this->mode == 'SANDBOX' ? 'sandbox' : 'production',
    ...
    {
        return in_array($status, ['submitted_for_settlement', 'authorized', 'settled', 'settling']);
    }
