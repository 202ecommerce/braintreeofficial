...
<div class="alert alert-info">
    ...
    <div>
        {l s='Please note that the additional delivery fees (%1s) have been applied. For more details, please check your order summary.' sprintf=[$carrierFees] mod='braintreeofficial'}
    </div>
</div>
