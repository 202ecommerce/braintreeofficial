...
function upgrade_module_1_1_1($module)
{
    ...
    $result &= $installer->installObjectModel(BraintreeOfficialCustomer::class);
    $result &= $serviceBraintreeCustomer->setProfileKeyForCustomers(true);
    $result &= $serviceBraintreeCustomer->setProfileKeyForCustomers(false);
